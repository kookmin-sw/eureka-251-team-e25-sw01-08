    ...
    - **🗓️ 4주차 (09/26)**  
      ...
      > **MIT Sixth Sense 연구팀이 만들고자 했던 것은?**  
        ...
        * What?
          ...
          ```
          - 작은 프로젝터와 카메라를 활용해, 언제 어디서나 손동작과 사물 위에 정보를 시각화하고 조작할 수 있는 웨어러블 장치 → 현실 속 사물에 디지털 정보를 투영하고, 손가락 제스처로 상호작용 가능
          ```
      ...
      > **As-Is vs To-Be는 어떻게? 기존 컴퓨터의 입력, 출력 장치를 어떠한 방식으로 변경하였나요??**  
        * 키보드는?
          ...
          ```
          - 키보드 → 손 제스처
          - 문자를 입력하거나 명령을 주는 방식이 키보드 대신 손동작으로 전환 (예: 공중에서 손가락으로 사각형을 그리면 카메라 촬영)
          ```
        * 마우스는?
      ...
      > **MIT Sixth Sense Project 팀이 만든 내용이 현재에는 어떠한 장비로, 어떻게 구현이 되었을까?**  
        * 현재의 기술과 약 15년 전에 MIT에서 진행한 기술의 발전 모습은?
          ...
          - 현재 기술 (2025년 시점)
            -  AR 글래스 (예: Microsoft HoloLens, Meta Quest, Apple Vision Pro) → 화면을 어디서든 띄우고 손 제스처로 제어 가능
